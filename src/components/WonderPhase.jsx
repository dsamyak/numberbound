...
const WONDER_QUESTIONS = [
  {
    question: "If I have 9 cookies and eat 4... what's left?",
    subtext: "What if there's a magic way to find the missing part?",
    emoji: "🍪",
    bgEmojis: ["🍪", "➖", "🔢", "✨"],
  },
  {
    question: "If there are 12 birds and 5 fly away, how many stay?",
    subtext: "Taking away is like a puzzle — we just need to find the missing piece!",
    emoji: "🐦",
    bgEmojis: ["🐦", "💡", "🌳", "🧩"],
  },
  {
    question: "How can a number bond help us when we take things away?",
    subtext: "Number bonds are like secret maps for numbers!",
    emoji: "🗺️",
    bgEmojis: ["🗺️", "🎨", "🖍️", "🔍"],
  },
  {
    question: "If we know the whole and one part, can we find the other part?",
    subtext: "Subtraction is just finding the missing part of the team!",
    emoji: "🤝",
    bgEmojis: ["🤝", "🔢", "➖", "🎯"],
  },
  {
    question: "What happens when we take a big number and break it into two smaller parts?",
    subtext: "That's exactly what a number bond does!",
    emoji: "🔨",
    bgEmojis: ["🔨", "🔢", "➡️", "🎉"],
  },
];
